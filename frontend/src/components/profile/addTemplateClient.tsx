...
const AddTemplatePageClient: React.FC<Props> = ({ dictionary }) => {
  const dict = dictionary.ProfilePage.AddTemplate;
  ...
  return (
    <section className="flex-1">
      <div className="container max-w-4xl mx-auto">
        <TitleCard title={dict.title} href="/profile" linkName={dict.button} />
        <form onSubmit={handleSubmit}>
          <Card className="shadow-md">
            <CardContent className="space-y-6 p-6">
              <div className="w-full gap-4">
                <Label htmlFor="title">{dict.form.title}</Label>
                <Input name="title" id="title" placeholder={dict.form.title} />
              </div>
              ...
              <div className="flex gap-4 items-end">
                <div className="w-full">
                  ...
                  >
                    <SelectTrigger>
                      <SelectValue placeholder={dict.form.category} />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <div className="flex justify-end gap-4">
                <Button
                  ...
                  disabled={isLoading}
                >
                  {isLoading ? dict.form.loading : dict.form.submit}
                </Button>
              </div>
            </CardContent>
          </Card>
...
export default AddTemplatePageClient;
