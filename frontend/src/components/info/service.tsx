...
const Service: FC<ServiceProps> = ({ dictionary }) => {
  const [active, setActive] = React.useState<number | null>();
  const dict = dictionary.InfoPage.OurServices;
